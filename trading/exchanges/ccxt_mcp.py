...
class CCXTMCPAdapter:
    ...
    EXCHANGE_SYMBOL_MAP = {
        ...
        'binance': {
            # ggShot signal symbols (141 symbols from CONTEXT.md)
            # All ggShot symbols are USDT pairs and map directly to Binance format
            '1INCH/USDT': '1INCH/USDT',
            'AAVE/USDT': 'AAVE/USDT',
            'ACHUS/USDT': 'ACHUS/USDT',
            'ADA/USDT': 'ADA/USDT',
            'ALGO/USDT': 'ALGO/USDT',
            'ALICE/USDT': 'ALICE/USDT',
            'ALPHA/USDT': 'ALPHA/USDT',
            'ALT/USDT': 'ALT/USDT',
            'ANKR/USDT': 'ANKR/USDT',
            'APE/USDT': 'APE/USDT',
            'API3/USDT': 'API3/USDT',
            ...
            'KSM/USDT': 'KSM/USDT',
            'LDO/USDT': 'LDO/USDT',
            'LEVER/USDT': 'LEVER/USDT',
            'LINK/USDT': 'LINK/USDT',
            'LPT/USDT': 'LPT/USDT',
            'LQTY/USDT': 'LQTY/USDT',
            'LRC/USDT': 'LRC/USDT',
            'LTC/USDT': 'LTC/USDT',
            'MAGIC/USDT': 'MAGIC/USDT',
            'MANA/USDT': 'MANA/USDT',
            'MASK/USDT': 'MASK/USDT',
            ...
            'OP/USDT': 'OP/USDT',
            'ORDI/USDT': 'ORDI/USDT',
            'PENDLE/USDT': 'PENDLE/USDT',
            'PEOPLE/USDT': 'PEOPLE/USDT',
            'PYTH/USDT': 'PYTH/USDT',
            'QTUM/USDT': 'QTUM/USDT',
            'RARE/USDT': 'RARE/USDT',
