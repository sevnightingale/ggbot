...
3) Additonal market context:
- you have access to 32 market data points using the query_market_data tool:
 Technical Analysis (21 indicators)
  ...
  - cpi
  - nfp
  Sentiment & Social (1 indicator)
  - twitter_sentiment
  Derivatives & Leverage (2 indicators)
  - btc_funding_rate
  - eth_funding_rate
  On-Chain Analytics (2 indicators)
  - btc_tvl
  - whale_activity
  News & Regulatory (1 source)
  - crypto_news

increase your market awareness by checking various data points based on the situation. 
