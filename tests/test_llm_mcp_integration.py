...
class LLMMCPIntegrationTest:
    ...
    async def connect_to_mcp(self):
        ...
        os.environ["EXCHANGE_API"] = os.environ.get("EXCHANGE_API", "arfvFIW1EQSs_gm2OGooR_f4")
        os.environ["EXCHANGE_SECRET"] = os.environ.get("EXCHANGE_SECRET", "a8XHhSw8IX5OAp3wOfRAypNUrQj1y5k3tNWWd4O6gZ9GrIGU")
