    ...
    <nav className="relative z-50">
      ...
      {isMenuOpen && (
        <>
          ...
          />
          <div className="absolute right-0 top-full mt-2 mr-6 bg-charcoal-800 border border-bone-200/20 rounded-lg p-4 min-w-[200px] z-50">
            <ul className="space-y-2">
              <li>
                <a 
                  href="/app" 
                  className="block px-4 py-2 hover:bg-charcoal-700 rounded-md transition-colors"
                  onClick={() => setIsMenuOpen(false)}
                >
                  My Bots
                </a>
