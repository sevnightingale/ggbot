      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 md:left-8 md:right-8 lg:left-16 lg:right-16 xl:left-24 xl:right-24 z-50 rounded-t-2xl shadow-2xl bg-[var(--bg-secondary)] border-t-2 border-[var(--accent)]"
