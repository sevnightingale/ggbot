...
// CountdownTimer — preserved for Season 2 reuse
export function CountdownTimer({ targetTime }: { targetTime: number }) {
    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
        ...
        {!loading && data && autonomousBots.length > 0 && (
          <>
            ...
            <p className="text-sm text-[var(--text-secondary)] mb-4 max-w-2xl">
              These bots had zero manual intervention — every trade was opened and closed by AI alone.
            </p>
            <div className="rounded-2xl border border-green-500/20 bg-[var(--bg-secondary)] overflow-hidden mb-10">
              <div className="divide-y divide-[var(--border)]">
                {autonomousBots.map((bot, index) => {
                  const pnlPercent = ((bot.current_equity - bot.initial_balance) / bot.initial_balance) * 100
                  const isPositive = pnlPercent >= 0
                  ...
                  return (
                    <div
                      ...
                      className={`transition-all duration-200 ${
                        isLeader ? 'bg-green-500/10 border-l-4 border-l-green-500' : ''
                      }`}
                    >
                        ...
                        <div className="flex items-center gap-3 md:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <span className={`text-sm md:text-base font-semibold truncate ${isLeader ? 'text-green-500' : 'text-[var(--text-primary)]'}`}>
                                {bot.config_name}
                              </span>
                              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider bg-green-500/15 text-green-500 border border-green-500/30">
                          ...
                          <div className="text-right flex-shrink-0">
                            <div className={`text-base md:text-lg font-mono font-bold ${isLeader ? 'text-green-500' : 'text-[var(--text-primary)]'}`}>
              ...
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display text-xl text-[var(--text-primary)]">
                  ...
                  <span className="ml-2 text-sm font-normal text-[var(--text-muted)]">
                    All {rankedBots.length} participants
                  </span>
                </h3>
              </div>
            </div>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3 md:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <span className={`text-sm md:text-base font-semibold truncate ${isLeader ? 'text-[var(--accent)]' : 'text-[var(--text-primary)]'}`}>
                                {bot.config_name}
                              </span>
                              {bot.manual_closes === 0 && (
                                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider bg-green-500/15 text-green-500 border border-green-500/30 flex-shrink-0">
                                  <Shield className="h-2.5 w-2.5" />
                                  Auto
                                </span>
                              )}
                      ...
                      {isExpanded && (
                        <div className="px-4 pb-5 pt-2 bg-[var(--bg-tertiary)]/30">
                          <div className="space-y-5">
                            ...
                            {/* Bet CTA — hidden for Season 1 complete, preserve for Season 2 */}
                            {false && (
                            <button
                              onClick={(e) => {
                                e.stopPropagation()
      ...
      <footer className="border-t border-[var(--border)] py-8">
        <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 text-center">
          {['AI-Powered Trading', 'Paper Markets', 'Autonomous AI', 'Built in the Forge'].map(phrase => (
