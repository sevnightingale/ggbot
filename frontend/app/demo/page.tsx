        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-3 relative">
          ...
          <div className="hidden lg:block pr-8">
            ...
            <div className="flex flex-col min-h-[500px]">
              ...
              <div className="relative p-6 corner-brackets gradient-borders min-h-[120px]">
          ...
          <div className="hidden lg:block pl-8">
            ...
            <div className="flex flex-col min-h-[500px]">
              ...
              <div className="relative p-6 mb-6 flex-1 corner-brackets gradient-borders min-h-[200px]">
              ...
              <div className="relative p-6 corner-brackets gradient-borders min-h-[80px]">
                <div className="flex justify-between items-center">
