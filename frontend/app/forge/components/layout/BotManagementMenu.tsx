        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-lg p-4 shadow-lg min-w-64">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={isBotAction}
              className="inline-flex items-center gap-1.5 px-3 py-2 bg-[var(--accent)] text-[#edebe7] dark:text-[#1a1816] rounded hover:bg-[var(--accent-hover)] disabled:opacity-50 text-xs font-medium"
            >
