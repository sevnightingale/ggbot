...
function getTier(elo: number): TierInfo {
  ...
  if (elo >= 1200) return { name: 'Journeyman', color: '#3b82f6', icon: '◆', bgClass: 'bg-blue-500/10', textClass: 'text-blue-400' }
  if (elo >= 1000) return { name: 'Apprentice', color: '#22c55e', icon: '●', bgClass: 'bg-green-500/10', textClass: 'text-green-400' }
  return { name: 'Novice', color: '#9ca3af', icon: '○', bgClass: 'bg-gray-500/10', textClass: 'text-gray-400' }
}
